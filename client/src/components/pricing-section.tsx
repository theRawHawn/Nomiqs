    ...
    <section className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardContent className="p-8">
              <div className="text-center mb-8">
                ...
                <div className="text-3xl font-bold text-primary-600 mb-2">₹700 - ₹1,000</div>
          ...
          <Card className="border-2 border-primary-600 shadow-lg relative">
            ...
            <CardContent className="p-8 pt-12">
              <div className="text-center mb-8">
                ...
                <div className="text-3xl font-bold text-primary-600 mb-2">₹1,200 - ₹1,800</div>
                <p className="text-gray-600">per month</p>
              </div>
        ...
        <div className="bg-gray-50 rounded-xl p-8">
          <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">Payroll Add-on Services</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              <CardContent className="p-6">
                <h4 className="text-xl font-semibold text-gray-900 mb-2">Up to 5 Employees</h4>
                <div className="text-2xl font-bold text-primary-600 mb-3">₹500/month</div>
            ...
            <Card>
              <CardContent className="p-6">
                <h4 className="text-xl font-semibold text-gray-900 mb-2">Up to 15 Employees</h4>
                <div className="text-2xl font-bold text-primary-600 mb-3">₹1,000/month</div>
